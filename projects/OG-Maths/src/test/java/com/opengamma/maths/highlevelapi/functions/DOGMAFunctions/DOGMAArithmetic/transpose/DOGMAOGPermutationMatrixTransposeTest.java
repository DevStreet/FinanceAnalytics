...
import com.opengamma.maths.highlevelapi.functions.DOGMAArithmetic.transpose.TransposeOGPermutationMatrix;
...
public class DOGMAOGPermutationMatrixTransposeTest {
  ...
  TransposeOGPermutationMatrix t = new TransposeOGPermutationMatrix();
