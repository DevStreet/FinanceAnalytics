...
import com.opengamma.maths.highlevelapi.functions.DOGMAArithmetic.ctranspose.CtransposeOGIndexMatrix;
...
public class DOGMAOGIndexMatrixCtransposeTest {
  ...
  CtransposeOGIndexMatrix ct = new CtransposeOGIndexMatrix();
