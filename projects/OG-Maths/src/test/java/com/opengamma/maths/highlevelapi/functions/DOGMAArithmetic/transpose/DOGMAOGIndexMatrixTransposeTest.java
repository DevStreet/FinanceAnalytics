...
import com.opengamma.maths.highlevelapi.functions.DOGMAArithmetic.transpose.TransposeOGIndexMatrix;

/**
 * Tests OGDoubleArray transpose
 */
public class DOGMAOGIndexMatrixTransposeTest {

  TransposeOGIndexMatrix t = new TransposeOGIndexMatrix();
