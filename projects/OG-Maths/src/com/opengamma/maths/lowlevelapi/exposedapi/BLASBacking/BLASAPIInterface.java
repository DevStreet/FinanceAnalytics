...
public interface BLASAPIInterface {
  ...
  */
  ...
  /**
   * 
   * Provides BLAS LEVEL 2: DTRSV
   * DTRSV solves one of the systems of equations
   * 
   * A*x = b or  A^T*x = b
   * where x and b are vectors and A is an n by n unit or non-uni upper or lower triangular matrix.
   * The ^T indicates transposition.
   *  
   ...
   * diag = 'N'
   * n = 5
   * aMatrix={1,0,0,0,0,2,7,0,0,0,3,8,13,0,0,4,9,14,19,0,5,10,15,20,25} // elements set to 0 are not accessed.
   * lda = n
   * x = {15,34,42,39,25 }
   * incx = 1;
   * 
   * Call:
   * dtrsv(uplo,trans,diag,n,aMatrix,lda,x,incx)
   * 
   * Output
   * uplo = 'U'
   * trans = 'N'
   * diag = 'N'
   * n = 5
   * aMatrix={1,0,0,0,0,2,7,0,0,0,3,8,13,0,0,4,9,14,19,0,5,10,15,20,25}
   * lda = n
   * x = {1,1,1,1,1}
   * incx = 1;
   * 
