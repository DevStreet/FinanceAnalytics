...
public class Cosh {
   ...
   */
  private static Map<Class<?>, CoshAbstract<?>> s_functionPointers = new HashMap<Class<?>, CoshAbstract<?>>();
  static {
  ...
  public <T extends OGArraySuper<Number>> OGArraySuper<Number> cosh(T array1) {
