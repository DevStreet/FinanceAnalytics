...
public class Sin {
   ...
   */
  private static Map<Class<?>, SinAbstract<?>> s_functionPointers = new HashMap<Class<?>, SinAbstract<?>>();
  static {
  ...
  public <T extends OGArraySuper<Number>> OGArraySuper<Number> sin(T array1) {
