...
public class Cos {
   ...
   */
  private static Map<Class<?>, CosAbstract<?>> s_functionPointers = new HashMap<Class<?>, CosAbstract<?>>();
  static {
  ...
  public <T extends OGArraySuper<Number>> OGArraySuper<Number> cos(T array1) {
