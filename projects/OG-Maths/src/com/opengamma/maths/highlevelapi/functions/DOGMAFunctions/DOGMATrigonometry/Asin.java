...
import com.opengamma.maths.highlevelapi.functions.DOGMAFunctions.DOGMATrigonometry.asin.AsinOGMatrix;
import com.opengamma.maths.highlevelapi.functions.DOGMAFunctions.DOGMATrigonometry.asin.AsinOGSparseMatrix;
...
public class Asin {
  ...
  static {
    s_functionPointers.put(OGMatrix.class, AsinOGMatrix.getInstance());
    s_functionPointers.put(OGSparseMatrix.class, AsinOGSparseMatrix.getInstance());    
  }
