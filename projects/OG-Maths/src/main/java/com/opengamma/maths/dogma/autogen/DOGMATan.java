 ...
 */
public class DOGMATan {
  private static DOGMATan s_instance;
  DOGMATan() {
  }
  public static DOGMATan getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Tan.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMATan(boolean verbose) {
    s_verbose = verbose;
  };
  ...
  private static UnaryFunctionChain[] s_tanInstructions;
static {
...
UnaryFunction<OGArray<? extends Number>, OGArray<? extends Number>>[] TanFunctionTable = MethodScraperForUnaryFunctions.availableMethodsForUnaryFunctions(operatorDictUnary.getOperationsMap(),Tan.class);
s_tanInstructions = MethodScraperForUnaryFunctions.computeFunctions(ConversionCostAdjacencyMatrixStore.getWeightedAdjacencyMatrix(),TanFunctionTable, defaultUnaryFunctionEvalCostsMatrix);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_tanInstructions[type1], arg0);
return tmp;
}

public static Number tan(Number arg0) {Catchers.catchNullFromArgList(arg0, 1);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_tanInstructions[type1], arg0rewrite);
