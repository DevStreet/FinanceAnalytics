 ...
 */
public class DOGMASin {
  private static DOGMASin s_instance;
  DOGMASin() {
  }
  public static DOGMASin getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Sin.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMASin(boolean verbose) {
    s_verbose = verbose;
  };
