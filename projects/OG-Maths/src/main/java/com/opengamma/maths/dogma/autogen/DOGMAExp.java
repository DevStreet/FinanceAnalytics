 ...
 */
public class DOGMAExp {
  private static DOGMAExp s_instance;
  DOGMAExp() {
  }
  public static DOGMAExp getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Exp.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMAExp(boolean verbose) {
    s_verbose = verbose;
  };
  ...
  private static UnaryFunctionChain[] s_expInstructions;
static {
...
UnaryFunction<OGArray<? extends Number>, OGArray<? extends Number>>[] ExpFunctionTable = MethodScraperForUnaryFunctions.availableMethodsForUnaryFunctions(operatorDictUnary.getOperationsMap(),Exp.class);
s_expInstructions = MethodScraperForUnaryFunctions.computeFunctions(ConversionCostAdjacencyMatrixStore.getWeightedAdjacencyMatrix(),ExpFunctionTable, defaultUnaryFunctionEvalCostsMatrix);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_expInstructions[type1], arg0);
return tmp;
}

public static Number exp(Number arg0) {Catchers.catchNullFromArgList(arg0, 1);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_expInstructions[type1], arg0rewrite);
