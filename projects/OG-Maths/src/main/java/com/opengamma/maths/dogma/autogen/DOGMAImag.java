 ...
 */
public class DOGMAImag {
  private static DOGMAImag s_instance;
  DOGMAImag() {
  }
  public static DOGMAImag getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Imag.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMAImag(boolean verbose) {
    s_verbose = verbose;
  };
  ...
  private static UnaryFunctionChain[] s_imagInstructions;
static {
...
UnaryFunction<OGArray<? extends Number>, OGArray<? extends Number>>[] ImagFunctionTable = MethodScraperForUnaryFunctions.availableMethodsForUnaryFunctions(operatorDictUnary.getOperationsMap(),Imag.class);
s_imagInstructions = MethodScraperForUnaryFunctions.computeFunctions(ConversionCostAdjacencyMatrixStore.getWeightedAdjacencyMatrix(),ImagFunctionTable, defaultUnaryFunctionEvalCostsMatrix);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_imagInstructions[type1], arg0);
return tmp;
}

public static Number imag(Number arg0) {Catchers.catchNullFromArgList(arg0, 1);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_imagInstructions[type1], arg0rewrite);
