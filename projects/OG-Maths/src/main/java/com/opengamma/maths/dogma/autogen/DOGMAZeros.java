 ...
 */
public class DOGMAZeros {
  private static DOGMAZeros s_instance;
  DOGMAZeros() {
  }
  public static DOGMAZeros getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Zeros.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMAZeros(boolean verbose) {
    s_verbose = verbose;
  };
  ...
  private static com.opengamma.maths.highlevelapi.functions.DOGMAFunctions.DOGMASpecialMatrices.ZerosFunction s_zerosfunction = new com.opengamma.maths.highlevelapi.functions.DOGMAFunctions.DOGMASpecialMatrices.ZerosFunction();
static {
...
OperatorDictionaryPopulator<VoidUnaryFunction<OGArray<? extends Number>>> operatorDictVoidUnary = OperatorDictionaryPopulatorLibrary.getVoidUnaryOperatorDictionary();
  ...
  public static com.opengamma.maths.highlevelapi.datatypes.OGMatrix zeros(Integer arg0){
Catchers.catchNull(arg0);
    return   s_zerosfunction.zeros( arg0);
  };
  public static com.opengamma.maths.highlevelapi.datatypes.OGMatrix zeros(Integer arg0, Integer arg1){
Catchers.catchNull(arg0);
