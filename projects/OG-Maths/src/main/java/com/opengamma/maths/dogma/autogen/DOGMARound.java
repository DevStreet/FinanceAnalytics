 ...
 */
public class DOGMARound {
  private static DOGMARound s_instance;
  DOGMARound() {
  }
  public static DOGMARound getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Round.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMARound(boolean verbose) {
    s_verbose = verbose;
  };
  ...
  private static UnaryFunctionChain[] s_roundInstructions;
static {
...
UnaryFunction<OGArray<? extends Number>, OGArray<? extends Number>>[] RoundFunctionTable = MethodScraperForUnaryFunctions.availableMethodsForUnaryFunctions(operatorDictUnary.getOperationsMap(),Round.class);
s_roundInstructions = MethodScraperForUnaryFunctions.computeFunctions(ConversionCostAdjacencyMatrixStore.getWeightedAdjacencyMatrix(),RoundFunctionTable, defaultUnaryFunctionEvalCostsMatrix);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_roundInstructions[type1], arg0);
return tmp;
}

public static Number round(Number arg0) {Catchers.catchNullFromArgList(arg0, 1);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_roundInstructions[type1], arg0rewrite);
