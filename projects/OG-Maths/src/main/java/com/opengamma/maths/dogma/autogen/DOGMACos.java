 ...
 */
public class DOGMACos {
  private static DOGMACos s_instance;
  DOGMACos() {
  }
  public static DOGMACos getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Cos.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMACos(boolean verbose) {
    s_verbose = verbose;
  };
  ...
  private static UnaryFunctionChain[] s_cosInstructions;
static {
...
UnaryFunction<OGArray<? extends Number>, OGArray<? extends Number>>[] CosFunctionTable = MethodScraperForUnaryFunctions.availableMethodsForUnaryFunctions(operatorDictUnary.getOperationsMap(),Cos.class);
s_cosInstructions = MethodScraperForUnaryFunctions.computeFunctions(ConversionCostAdjacencyMatrixStore.getWeightedAdjacencyMatrix(),CosFunctionTable, defaultUnaryFunctionEvalCostsMatrix);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_cosInstructions[type1], arg0);
return tmp;
}

public static Number cos(Number arg0) {Catchers.catchNullFromArgList(arg0, 1);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_cosInstructions[type1], arg0rewrite);
