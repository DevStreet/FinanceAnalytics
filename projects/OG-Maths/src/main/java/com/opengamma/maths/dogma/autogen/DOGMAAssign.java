 ...
 */
public class DOGMAAssign {
  private static DOGMAAssign s_instance;
  DOGMAAssign() {
  }
  public static DOGMAAssign getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Assign.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMAAssign(boolean verbose) {
    s_verbose = verbose;
  };
  ...
  private static com.opengamma.maths.highlevelapi.functions.DOGMAFunctions.DOGMAIndexing.assign.AssignOGMatrixOGMatrix s_assignogmatrixogmatrix = new com.opengamma.maths.highlevelapi.functions.DOGMAFunctions.DOGMAIndexing.assign.AssignOGMatrixOGMatrix();
static {
...
OperatorDictionaryPopulator<VoidUnaryFunction<OGArray<? extends Number>>> operatorDictVoidUnary = OperatorDictionaryPopulatorLibrary.getVoidUnaryOperatorDictionary();
  ...
  public static com.opengamma.maths.highlevelapi.datatypes.primitive.OGArray<? extends java.lang.Number> assign(OGMatrix arg0, int[] arg1, int[] arg2, OGMatrix arg3){
    return   s_assignogmatrixogmatrix.assign( arg0,  arg1,  arg2,  arg3);
  };
  public static com.opengamma.maths.highlevelapi.datatypes.primitive.OGArray<? extends java.lang.Number> assign(OGMatrix arg0, OGMatrix arg1, OGMatrix arg2, OGMatrix arg3){
    return   s_assignogmatrixogmatrix.assign( arg0,  arg1,  arg2,  arg3);
  };
  public static com.opengamma.maths.highlevelapi.datatypes.primitive.OGArray<? extends java.lang.Number> assign(OGMatrix arg0, com.opengamma.maths.highlevelapi.functions.DOGMAFunctions.DOGMAIndexing.assign.Index arg1, OGMatrix arg2, OGMatrix arg3){
    return   s_assignogmatrixogmatrix.assign( arg0,  arg1,  arg2,  arg3);
  };
  public static com.opengamma.maths.highlevelapi.datatypes.primitive.OGArray<? extends java.lang.Number> assign(OGMatrix arg0, OGMatrix arg1, com.opengamma.maths.highlevelapi.functions.DOGMAFunctions.DOGMAIndexing.assign.Index arg2, OGMatrix arg3){
    return   s_assignogmatrixogmatrix.assign( arg0,  arg1,  arg2,  arg3);
  };
