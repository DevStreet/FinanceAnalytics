 ...
 */
public class DOGMAReal {
  private static DOGMAReal s_instance;
  DOGMAReal() {
  }
  public static DOGMAReal getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Real.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMAReal(boolean verbose) {
    s_verbose = verbose;
  };
  ...
  private static UnaryFunctionChain[] s_realInstructions;
static {
...
UnaryFunction<OGArray<? extends Number>, OGArray<? extends Number>>[] RealFunctionTable = MethodScraperForUnaryFunctions.availableMethodsForUnaryFunctions(operatorDictUnary.getOperationsMap(),Real.class);
s_realInstructions = MethodScraperForUnaryFunctions.computeFunctions(ConversionCostAdjacencyMatrixStore.getWeightedAdjacencyMatrix(),RealFunctionTable, defaultUnaryFunctionEvalCostsMatrix);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_realInstructions[type1], arg0);
return tmp;
}

public static Number real(Number arg0) {Catchers.catchNullFromArgList(arg0, 1);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_realInstructions[type1], arg0rewrite);
