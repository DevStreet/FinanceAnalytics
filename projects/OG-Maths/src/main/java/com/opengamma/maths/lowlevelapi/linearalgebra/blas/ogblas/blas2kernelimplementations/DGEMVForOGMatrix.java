 ...
 */
package com.opengamma.maths.lowlevelapi.linearalgebra.blas.ogblas.blas2kernelimplementations;
...
/**
 * Does DGEMV like operations on the {@link OGMatrix} type
 */
public final class DGEMVForOGMatrix extends BLAS2DGEMVKernelAbstraction<OGMatrix> {
  private static DGEMVForOGMatrix s_instance = new DGEMVForOGMatrix();

  public static DGEMVForOGMatrix getInstance() {
    return s_instance;
  }

  private DGEMVForOGMatrix() {
  }
   ...
   */
  @Override
  public double[] dm_stateless_A_times_x(OGMatrix aMatrix, double[] aVector) { //CSIGNORE
   ...
   */
  @Override
  public double[] dm_stateless_AT_times_x(OGMatrix aMatrix, double[] aVector) { //CSIGNORE
    final int rows = aMatrix.getNumberOfRows();
    final int cols = aMatrix.getNumberOfColumns();
   ...
   */
  @Override
  public double[] dm_stateless_alpha_times_A_times_x(double alpha, OGMatrix aMatrix, double[] aVector) { //CSIGNORE
    final int rows = aMatrix.getNumberOfRows();
   ...
   */
  @Override
  public double[] dm_stateless_alpha_times_AT_times_x(double alpha, OGMatrix aMatrix, double[] aVector) { //CSIGNORE
    final int cols = aMatrix.getNumberOfColumns();
   ...
   */
  @Override
  public double[] dm_stateless_A_times_x_plus_y(OGMatrix aMatrix, double[] aVector, double[] y) { //CSIGNORE
    final int rows = aMatrix.getNumberOfRows();
    double[] tmp = dm_stateless_A_times_x(aMatrix, aVector);
    for (int i = 0; i < rows; i++) {
   ...
   */
  @Override
  public double[] dm_stateless_AT_times_x_plus_y(OGMatrix aMatrix, double[] aVector, double[] y) { //CSIGNORE
    final int cols = aMatrix.getNumberOfColumns();
    double[] tmp = dm_stateless_AT_times_x(aMatrix, aVector);
    for (int i = 0; i < cols; i++) {
      tmp[i] += y[i]; // slight cache thrash but should help force A*x to be JITed
   ...
   */
  @Override
  public double[] dm_stateless_alpha_times_A_times_x_plus_y(double alpha, OGMatrix A, double[] x, double[] y) { //CSIGNORE
   ...
   */
  @Override
  public double[] dm_stateless_alpha_times_AT_times_x_plus_y(double alpha, OGMatrix A, double[] x, double[] y) { //CSIGNORE
   ...
   */
  @Override
  public double[] dm_stateless_A_times_x_plus_beta_times_y(OGMatrix A, double[] x, double beta, double[] y) { //CSIGNORE
    final int rows = A.getNumberOfRows();
    double[] tmp = dm_stateless_A_times_x(A, x);
    for (int i = 0; i < rows; i++) {
   ...
   */
  @Override
  public double[] dm_stateless_AT_times_x_plus_beta_times_y(OGMatrix A, double[] x, double beta, double[] y) { //CSIGNORE
    final int cols = A.getNumberOfColumns();
    double[] tmp = dm_stateless_AT_times_x(A, x);
    for (int i = 0; i < cols; i++) {
      tmp[i] += beta * y[i]; // slight cache thrash but should help force A*x to be JITed
   ...
   */
  @Override
  public double[] dm_stateless_alpha_times_A_times_x_plus_beta_times_y(double alpha, OGMatrix A, double[] x, double beta, double[] y) { //CSIGNORE
    final int rows = A.getNumberOfRows();
    double[] tmp = dm_stateless_A_times_x(A, x);
    for (int i = 0; i < rows; i++) {
   ...
   */
  @Override
  public double[] dm_stateless_alpha_times_AT_times_x_plus_beta_times_y(double alpha, OGMatrix A, double[] x, double beta, double[] y) { //CSIGNORE
    final int cols = A.getNumberOfColumns();
    double[] tmp = dm_stateless_AT_times_x(A, x);
    for (int i = 0; i < cols; i++) {
   ...
   */
  @Override
  public void dm_inplace_A_times_x(double[] y, OGMatrix A, double[] x) { //CSIGNORE
    final int rows = A.getNumberOfRows();
    final int cols = A.getNumberOfColumns();
   ...
   */
  @Override
  public void dm_inplace_AT_times_x(double[] y, OGMatrix A, double[] x) { //CSIGNORE
    final int rows = A.getNumberOfRows();
    final int cols = A.getNumberOfColumns();
    double[] ptrA = A.getData();
    int idx0, idx1, idx2, idx3, idx4, idx5, idx6, idx7;
   ...
   */
  @Override
  public void dm_inplace_alpha_times_A_times_x(double[] y, double alpha, OGMatrix A, double[] x) { //CSIGNORE
   ...
   */
  @Override
  public void dm_inplace_alpha_times_AT_times_x(double[] y, double alpha, OGMatrix A, double[] x) { //CSIGNORE
    final int rows = A.getNumberOfRows();
    final int cols = A.getNumberOfColumns();
    double[] ptrA = A.getData();
    int idx0, idx1, idx2, idx3, idx4, idx5, idx6, idx7;
   ...
   */
  @Override
  public void dm_inplace_A_times_x_plus_y(double[] y, OGMatrix A, double[] x) { //CSIGNORE
    final double[] ptrA = A.getData();
    final int rows = A.getNumberOfRows();
    final int cols = A.getNumberOfColumns();
    double alphaTmp, acc;
  ...
  */
  @Override
  public void dm_inplace_AT_times_x_plus_y(double[] y, OGMatrix A, double[] x) { //CSIGNORE
    final int rows = A.getNumberOfRows();
    final int cols = A.getNumberOfColumns();
    double[] ptrA = A.getData();
    int idx0, idx1, idx2, idx3, idx4, idx5, idx6, idx7;
   ...
   */
  @Override
  public void dm_inplace_alpha_times_A_times_x_plus_y(double[] y, double alpha, OGMatrix A, double[] x) { //CSIGNORE
    final double[] ptrA = A.getData();
    final int rows = A.getNumberOfRows();
    final int cols = A.getNumberOfColumns();
    double alphaTmp;
   ...
   */
  @Override
  public void dm_inplace_alpha_times_AT_times_x_plus_y(double[] y, double alpha, OGMatrix A, double[] x) { //CSIGNORE
    final int cols = A.getNumberOfColumns();
    final int rows = A.getNumberOfRows();
    double[] ptrA = A.getData();
    double alphaTmp;
   ...
   */
  @Override
  public void dm_inplace_A_times_x_plus_beta_times_y(double[] y, OGMatrix A, double[] x, double beta) { //CSIGNORE
    final double[] ptrA = A.getData();
    final int rows = A.getNumberOfRows();
    final int cols = A.getNumberOfColumns();
    double alphaTmp;
   ...
   */
  @Override
 public void dm_inplace_AT_times_x_plus_beta_times_y(double[] y, OGMatrix A, double[] x, double beta) { //CSIGNORE
    final int cols = A.getNumberOfColumns();
    for (int i = 0; i < cols; i++) {
      y[i] = beta * y[i];
    }
   ...
   */
  @Override
  public void dm_inplace_alpha_times_A_times_x_plus_beta_times_y(double[] y, double alpha, OGMatrix A, double[] x, double beta) { //CSIGNORE
    final double[] ptrA = A.getData();
    final int rows = A.getNumberOfRows();
    final int cols = A.getNumberOfColumns();
    double alphaTmp;
   ...
   */
  @Override
  public void dm_inplace_alpha_times_AT_times_x_plus_beta_times_y(double[] y, double alpha, OGMatrix A, double[] x, double beta) { //CSIGNORE
    final int cols = A.getNumberOfColumns();
    for (int i = 0; i < cols; i++) {
      y[i] = beta * y[i];
    }
