 ...
 */
public class DOGMAMtimes {
  private static DOGMAMtimes s_instance;
  DOGMAMtimes() {
  }
  public static DOGMAMtimes getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Mtimes.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMAMtimes(boolean verbose) {
    s_verbose = verbose;
  };
