 ...
 */
public class DOGMANormCDF {
  private static DOGMANormCDF s_instance;
  DOGMANormCDF() {
  }
  public static DOGMANormCDF getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(NormCDF.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMANormCDF(boolean verbose) {
    s_verbose = verbose;
  };
  ...
  private static UnaryFunctionChain[] s_normcdfInstructions;
static {
...
UnaryFunction<OGArray<? extends Number>, OGArray<? extends Number>>[] NormCDFFunctionTable = MethodScraperForUnaryFunctions.availableMethodsForUnaryFunctions(operatorDictUnary.getOperationsMap(),NormCDF.class);
s_normcdfInstructions = MethodScraperForUnaryFunctions.computeFunctions(ConversionCostAdjacencyMatrixStore.getWeightedAdjacencyMatrix(),NormCDFFunctionTable, defaultUnaryFunctionEvalCostsMatrix);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_normcdfInstructions[type1], arg0);
return tmp;
}

public static Number normcdf(Number arg0) {Catchers.catchNullFromArgList(arg0, 1);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_normcdfInstructions[type1], arg0rewrite);
