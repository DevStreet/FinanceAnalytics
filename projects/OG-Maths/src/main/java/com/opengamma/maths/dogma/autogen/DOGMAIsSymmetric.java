 ...
 */
public class DOGMAIsSymmetric {
  private static DOGMAIsSymmetric s_instance;
  DOGMAIsSymmetric() {
  }
  public static DOGMAIsSymmetric getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(IsSymmetric.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMAIsSymmetric(boolean verbose) {
    s_verbose = verbose;
  };
  ...
  private static UnaryFunctionChain[] s_issymmetricInstructions;
static {
...
UnaryFunction<OGArray<? extends Number>, OGArray<? extends Number>>[] IsSymmetricFunctionTable = MethodScraperForUnaryFunctions.availableMethodsForUnaryFunctions(operatorDictUnary.getOperationsMap(),IsSymmetric.class);
s_issymmetricInstructions = MethodScraperForUnaryFunctions.computeFunctions(ConversionCostAdjacencyMatrixStore.getWeightedAdjacencyMatrix(),IsSymmetricFunctionTable, defaultUnaryFunctionEvalCostsMatrix);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_issymmetricInstructions[type1], arg0);
return tmp;
}

public static Number issymmetric(Number arg0) {Catchers.catchNullFromArgList(arg0, 1);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_issymmetricInstructions[type1], arg0rewrite);
