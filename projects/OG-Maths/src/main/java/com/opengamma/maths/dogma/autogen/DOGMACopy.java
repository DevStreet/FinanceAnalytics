 ...
 */
public class DOGMACopy {
  private static DOGMACopy s_instance;
  DOGMACopy() {
  }
  public static DOGMACopy getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Copy.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMACopy(boolean verbose) {
    s_verbose = verbose;
  };
