 ...
 */
public class DOGMACosh {
  private static DOGMACosh s_instance;
  DOGMACosh() {
  }
  public static DOGMACosh getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Cosh.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMACosh(boolean verbose) {
    s_verbose = verbose;
  };
  ...
  private static UnaryFunctionChain[] s_coshInstructions;
static {
...
UnaryFunction<OGArray<? extends Number>, OGArray<? extends Number>>[] CoshFunctionTable = MethodScraperForUnaryFunctions.availableMethodsForUnaryFunctions(operatorDictUnary.getOperationsMap(),Cosh.class);
s_coshInstructions = MethodScraperForUnaryFunctions.computeFunctions(ConversionCostAdjacencyMatrixStore.getWeightedAdjacencyMatrix(),CoshFunctionTable, defaultUnaryFunctionEvalCostsMatrix);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_coshInstructions[type1], arg0);
return tmp;
}

public static Number cosh(Number arg0) {Catchers.catchNullFromArgList(arg0, 1);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_coshInstructions[type1], arg0rewrite);
