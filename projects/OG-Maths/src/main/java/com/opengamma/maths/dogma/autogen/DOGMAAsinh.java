 ...
 */
public class DOGMAAsinh {
  private static DOGMAAsinh s_instance;
  DOGMAAsinh() {
  }
  public static DOGMAAsinh getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Asinh.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMAAsinh(boolean verbose) {
    s_verbose = verbose;
  };
  ...
  private static UnaryFunctionChain[] s_asinhInstructions;
static {
...
UnaryFunction<OGArray<? extends Number>, OGArray<? extends Number>>[] AsinhFunctionTable = MethodScraperForUnaryFunctions.availableMethodsForUnaryFunctions(operatorDictUnary.getOperationsMap(),Asinh.class);
s_asinhInstructions = MethodScraperForUnaryFunctions.computeFunctions(ConversionCostAdjacencyMatrixStore.getWeightedAdjacencyMatrix(),AsinhFunctionTable, defaultUnaryFunctionEvalCostsMatrix);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_asinhInstructions[type1], arg0);
return tmp;
}

public static Number asinh(Number arg0) {Catchers.catchNullFromArgList(arg0, 1);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_asinhInstructions[type1], arg0rewrite);
