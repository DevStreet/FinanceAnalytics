...
public class DOGMALog {
  private static DOGMALog s_instance;
  DOGMALog() {
  }
  public static DOGMALog getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Log.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMALog(boolean verbose) {
    s_verbose = verbose;
  };
  ...
  private static UnaryFunctionChain[] s_logInstructions;
static {
...
UnaryFunction<OGArray<? extends Number>, OGArray<? extends Number>>[] LogFunctionTable = MethodScraperForUnaryFunctions.availableMethodsForUnaryFunctions(operatorDictUnary.getOperationsMap(),Log.class);
s_logInstructions = MethodScraperForUnaryFunctions.computeFunctions(ConversionCostAdjacencyMatrixStore.getWeightedAdjacencyMatrix(),LogFunctionTable, defaultUnaryFunctionEvalCostsMatrix);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_logInstructions[type1], arg0);
return tmp;
}

public static Number log(Number arg0) {Catchers.catchNullFromArgList(arg0, 1);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_logInstructions[type1], arg0rewrite);
