 ...
 */
public class DOGMAHorzcat {
  private static DOGMAHorzcat s_instance;
  DOGMAHorzcat() {
  }
  public static DOGMAHorzcat getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Horzcat.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMAHorzcat(boolean verbose) {
    s_verbose = verbose;
  };
