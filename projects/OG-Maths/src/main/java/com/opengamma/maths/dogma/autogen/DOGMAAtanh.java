 ...
 */
public class DOGMAAtanh {
  private static DOGMAAtanh s_instance;
  DOGMAAtanh() {
  }
  public static DOGMAAtanh getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Atanh.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMAAtanh(boolean verbose) {
    s_verbose = verbose;
  };
  ...
  private static UnaryFunctionChain[] s_atanhInstructions;
static {
...
UnaryFunction<OGArray<? extends Number>, OGArray<? extends Number>>[] AtanhFunctionTable = MethodScraperForUnaryFunctions.availableMethodsForUnaryFunctions(operatorDictUnary.getOperationsMap(),Atanh.class);
s_atanhInstructions = MethodScraperForUnaryFunctions.computeFunctions(ConversionCostAdjacencyMatrixStore.getWeightedAdjacencyMatrix(),AtanhFunctionTable, defaultUnaryFunctionEvalCostsMatrix);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_atanhInstructions[type1], arg0);
return tmp;
}

public static Number atanh(Number arg0) {Catchers.catchNullFromArgList(arg0, 1);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_atanhInstructions[type1], arg0rewrite);
