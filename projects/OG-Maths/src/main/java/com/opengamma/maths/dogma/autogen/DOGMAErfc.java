 ...
 */
public class DOGMAErfc {
  private static DOGMAErfc s_instance;
  DOGMAErfc() {
  }
  public static DOGMAErfc getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Erfc.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMAErfc(boolean verbose) {
    s_verbose = verbose;
  };
