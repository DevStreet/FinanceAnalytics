 ...
 */
public class DOGMAConj {
  private static DOGMAConj s_instance;
  DOGMAConj() {
  }
  public static DOGMAConj getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Conj.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMAConj(boolean verbose) {
    s_verbose = verbose;
  };
  ...
  private static UnaryFunctionChain[] s_conjInstructions;
static {
...
UnaryFunction<OGArray<? extends Number>, OGArray<? extends Number>>[] ConjFunctionTable = MethodScraperForUnaryFunctions.availableMethodsForUnaryFunctions(operatorDictUnary.getOperationsMap(),Conj.class);
s_conjInstructions = MethodScraperForUnaryFunctions.computeFunctions(ConversionCostAdjacencyMatrixStore.getWeightedAdjacencyMatrix(),ConjFunctionTable, defaultUnaryFunctionEvalCostsMatrix);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_conjInstructions[type1], arg0);
return tmp;
}

public static Number conj(Number arg0) {Catchers.catchNullFromArgList(arg0, 1);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_conjInstructions[type1], arg0rewrite);
