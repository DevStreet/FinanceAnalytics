 ...
 */
public final class AsinOGSparseMatrix implements AsinAbstract<OGSparseMatrix> {
  private static AsinOGSparseMatrix s_instance = new AsinOGSparseMatrix();

  public static AsinOGSparseMatrix getInstance() {
    return s_instance;
  }

  private AsinOGSparseMatrix() {
  }
