 ...
 */
public class DOGMARdivide {
  private static DOGMARdivide s_instance;
  DOGMARdivide() {
  }
  public static DOGMARdivide getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Rdivide.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMARdivide(boolean verbose) {
    s_verbose = verbose;
  };
