 ...
 */
public class DOGMAHilb {
  private static DOGMAHilb s_instance;
  DOGMAHilb() {
  }
  public static DOGMAHilb getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Hilb.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMAHilb(boolean verbose) {
    s_verbose = verbose;
  };
  ...
  private static com.opengamma.maths.highlevelapi.functions.DOGMASpecialMatrices.HilbFunction s_hilbfunction = new com.opengamma.maths.highlevelapi.functions.DOGMASpecialMatrices.HilbFunction();
static {
...
OperatorDictionaryPopulator<VoidUnaryFunction<OGArray<? extends Number>>> operatorDictVoidUnary = OperatorDictionaryPopulatorLibrary.getVoidUnaryOperatorDictionary();
  ...
  public static com.opengamma.maths.highlevelapi.datatypes.OGMatrix hilb(Integer arg0){
