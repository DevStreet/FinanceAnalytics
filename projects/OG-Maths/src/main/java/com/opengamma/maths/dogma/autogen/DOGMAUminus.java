 ...
 */
public class DOGMAUminus {
  private static DOGMAUminus s_instance;
  DOGMAUminus() {
  }
  public static DOGMAUminus getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Uminus.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMAUminus(boolean verbose) {
    s_verbose = verbose;
  };
  ...
  private static UnaryFunctionChain[] s_uminusInstructions;
static {
...
UnaryFunction<OGArray<? extends Number>, OGArray<? extends Number>>[] UminusFunctionTable = MethodScraperForUnaryFunctions.availableMethodsForUnaryFunctions(operatorDictUnary.getOperationsMap(),Uminus.class);
s_uminusInstructions = MethodScraperForUnaryFunctions.computeFunctions(ConversionCostAdjacencyMatrixStore.getWeightedAdjacencyMatrix(),UminusFunctionTable, defaultUnaryFunctionEvalCostsMatrix);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_uminusInstructions[type1], arg0);
return tmp;
}

public static Number uminus(Number arg0) {Catchers.catchNullFromArgList(arg0, 1);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_uminusInstructions[type1], arg0rewrite);
