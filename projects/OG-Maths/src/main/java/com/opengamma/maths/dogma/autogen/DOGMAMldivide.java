 ...
 */
public class DOGMAMldivide {
  private static DOGMAMldivide s_instance;
  DOGMAMldivide() {
  }
  public static DOGMAMldivide getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Mldivide.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMAMldivide(boolean verbose) {
    s_verbose = verbose;
  };
