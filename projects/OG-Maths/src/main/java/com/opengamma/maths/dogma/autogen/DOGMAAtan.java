 ...
 */
public class DOGMAAtan {
  private static DOGMAAtan s_instance;
  DOGMAAtan() {
  }
  public static DOGMAAtan getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Atan.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMAAtan(boolean verbose) {
    s_verbose = verbose;
  };
  ...
  private static UnaryFunctionChain[] s_atanInstructions;
static {
...
UnaryFunction<OGArray<? extends Number>, OGArray<? extends Number>>[] AtanFunctionTable = MethodScraperForUnaryFunctions.availableMethodsForUnaryFunctions(operatorDictUnary.getOperationsMap(),Atan.class);
s_atanInstructions = MethodScraperForUnaryFunctions.computeFunctions(ConversionCostAdjacencyMatrixStore.getWeightedAdjacencyMatrix(),AtanFunctionTable, defaultUnaryFunctionEvalCostsMatrix);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_atanInstructions[type1], arg0);
return tmp;
}

public static Number atan(Number arg0) {Catchers.catchNullFromArgList(arg0, 1);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_atanInstructions[type1], arg0rewrite);
