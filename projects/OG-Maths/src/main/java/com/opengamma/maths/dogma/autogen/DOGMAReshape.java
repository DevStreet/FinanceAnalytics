 ...
 */
public class DOGMAReshape {
  private static DOGMAReshape s_instance;
  DOGMAReshape() {
  }
  public static DOGMAReshape getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Reshape.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMAReshape(boolean verbose) {
    s_verbose = verbose;
  };
...
OperatorDictionaryPopulator<VoidUnaryFunction<OGArray<? extends Number>>> operatorDictVoidUnary = OperatorDictionaryPopulatorLibrary.getVoidUnaryOperatorDictionary();
  ...
  public static com.opengamma.maths.highlevelapi.datatypes.OGMatrix reshape(OGMatrix arg0, Integer arg1, Integer arg2){
