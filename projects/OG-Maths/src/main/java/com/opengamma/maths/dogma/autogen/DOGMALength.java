 ...
 */
public class DOGMALength {
  private static DOGMALength s_instance;
  DOGMALength() {
  }
  public static DOGMALength getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Length.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMALength(boolean verbose) {
    s_verbose = verbose;
  };
  ...
  private static com.opengamma.maths.highlevelapi.functions.DOGMAFunctions.DOGMADimensions.length.LengthFunction s_lengthfunction = new com.opengamma.maths.highlevelapi.functions.DOGMAFunctions.DOGMADimensions.length.LengthFunction();
static {
