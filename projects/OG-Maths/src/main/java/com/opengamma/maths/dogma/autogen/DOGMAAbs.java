 ...
 */
public class DOGMAAbs {
  private static DOGMAAbs s_instance;
  DOGMAAbs() {
  }
  public static DOGMAAbs getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Abs.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMAAbs(boolean verbose) {
    s_verbose = verbose;
  };
  ...
  private static UnaryFunctionChain[] s_absInstructions;
static {
...
UnaryFunction<OGArray<? extends Number>, OGArray<? extends Number>>[] AbsFunctionTable = MethodScraperForUnaryFunctions.availableMethodsForUnaryFunctions(operatorDictUnary.getOperationsMap(),Abs.class);
s_absInstructions = MethodScraperForUnaryFunctions.computeFunctions(ConversionCostAdjacencyMatrixStore.getWeightedAdjacencyMatrix(),AbsFunctionTable, defaultUnaryFunctionEvalCostsMatrix);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_absInstructions[type1], arg0);
return tmp;
}

public static Number abs(Number arg0) {Catchers.catchNullFromArgList(arg0, 1);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_absInstructions[type1], arg0rewrite);
