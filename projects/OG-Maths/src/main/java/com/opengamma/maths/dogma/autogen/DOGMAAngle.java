 ...
 */
public class DOGMAAngle {
  private static DOGMAAngle s_instance;
  DOGMAAngle() {
  }
  public static DOGMAAngle getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Angle.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMAAngle(boolean verbose) {
    s_verbose = verbose;
  };
  ...
  private static UnaryFunctionChain[] s_angleInstructions;
static {
...
UnaryFunction<OGArray<? extends Number>, OGArray<? extends Number>>[] AngleFunctionTable = MethodScraperForUnaryFunctions.availableMethodsForUnaryFunctions(operatorDictUnary.getOperationsMap(),Angle.class);
s_angleInstructions = MethodScraperForUnaryFunctions.computeFunctions(ConversionCostAdjacencyMatrixStore.getWeightedAdjacencyMatrix(),AngleFunctionTable, defaultUnaryFunctionEvalCostsMatrix);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_angleInstructions[type1], arg0);
return tmp;
}

public static Number angle(Number arg0) {Catchers.catchNullFromArgList(arg0, 1);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_angleInstructions[type1], arg0rewrite);
