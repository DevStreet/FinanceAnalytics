 ...
 */
public class DOGMASqrt {
  private static DOGMASqrt s_instance;
  DOGMASqrt() {
  }
  public static DOGMASqrt getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Sqrt.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMASqrt(boolean verbose) {
    s_verbose = verbose;
  };
