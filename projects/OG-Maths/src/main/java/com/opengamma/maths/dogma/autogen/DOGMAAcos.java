 ...
 */
public class DOGMAAcos {
  private static DOGMAAcos s_instance;
  DOGMAAcos() {
  }
  public static DOGMAAcos getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Acos.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMAAcos(boolean verbose) {
    s_verbose = verbose;
  };
  ...
  private static UnaryFunctionChain[] s_acosInstructions;
static {
...
UnaryFunction<OGArray<? extends Number>, OGArray<? extends Number>>[] AcosFunctionTable = MethodScraperForUnaryFunctions.availableMethodsForUnaryFunctions(operatorDictUnary.getOperationsMap(),Acos.class);
s_acosInstructions = MethodScraperForUnaryFunctions.computeFunctions(ConversionCostAdjacencyMatrixStore.getWeightedAdjacencyMatrix(),AcosFunctionTable, defaultUnaryFunctionEvalCostsMatrix);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_acosInstructions[type1], arg0);
return tmp;
}

public static Number acos(Number arg0) {Catchers.catchNullFromArgList(arg0, 1);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_acosInstructions[type1], arg0rewrite);
