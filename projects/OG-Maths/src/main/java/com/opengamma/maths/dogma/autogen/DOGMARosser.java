 ...
 */
public class DOGMARosser {
  private static DOGMARosser s_instance;
  DOGMARosser() {
  }
  public static DOGMARosser getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Rosser.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMARosser(boolean verbose) {
    s_verbose = verbose;
  };
  ...
  private static com.opengamma.maths.highlevelapi.functions.DOGMASpecialMatrices.RosserFunction s_rosserfunction = new com.opengamma.maths.highlevelapi.functions.DOGMASpecialMatrices.RosserFunction();
static {
