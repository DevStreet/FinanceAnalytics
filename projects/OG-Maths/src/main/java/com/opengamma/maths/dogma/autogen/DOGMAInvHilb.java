 ...
 */
public class DOGMAInvHilb {
  private static DOGMAInvHilb s_instance;
  DOGMAInvHilb() {
  }
  public static DOGMAInvHilb getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(InvHilb.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMAInvHilb(boolean verbose) {
    s_verbose = verbose;
  };
  ...
  private static com.opengamma.maths.highlevelapi.functions.DOGMASpecialMatrices.InvhilbFunction s_invhilbfunction = new com.opengamma.maths.highlevelapi.functions.DOGMASpecialMatrices.InvhilbFunction();
static {
...
OperatorDictionaryPopulator<VoidUnaryFunction<OGArray<? extends Number>>> operatorDictVoidUnary = OperatorDictionaryPopulatorLibrary.getVoidUnaryOperatorDictionary();
  ...
  public static com.opengamma.maths.highlevelapi.datatypes.OGMatrix invhilb(Integer arg0){
