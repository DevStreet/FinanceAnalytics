 ...
 */
public class DOGMAAcosh {
  private static DOGMAAcosh s_instance;
  DOGMAAcosh() {
  }
  public static DOGMAAcosh getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Acosh.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMAAcosh(boolean verbose) {
    s_verbose = verbose;
  };
  ...
  private static UnaryFunctionChain[] s_acoshInstructions;
static {
...
UnaryFunction<OGArray<? extends Number>, OGArray<? extends Number>>[] AcoshFunctionTable = MethodScraperForUnaryFunctions.availableMethodsForUnaryFunctions(operatorDictUnary.getOperationsMap(),Acosh.class);
s_acoshInstructions = MethodScraperForUnaryFunctions.computeFunctions(ConversionCostAdjacencyMatrixStore.getWeightedAdjacencyMatrix(),AcoshFunctionTable, defaultUnaryFunctionEvalCostsMatrix);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_acoshInstructions[type1], arg0);
return tmp;
}

public static Number acosh(Number arg0) {Catchers.catchNullFromArgList(arg0, 1);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_acoshInstructions[type1], arg0rewrite);
