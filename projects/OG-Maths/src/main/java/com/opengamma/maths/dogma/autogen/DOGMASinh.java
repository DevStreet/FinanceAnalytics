 ...
 */
public class DOGMASinh {
  private static DOGMASinh s_instance;
  DOGMASinh() {
  }
  public static DOGMASinh getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Sinh.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMASinh(boolean verbose) {
    s_verbose = verbose;
  };
  ...
  private static UnaryFunctionChain[] s_sinhInstructions;
static {
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_sinhInstructions[type1], arg0);
return tmp;
}

public static Number sinh(Number arg0) {Catchers.catchNullFromArgList(arg0, 1);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_sinhInstructions[type1], arg0rewrite);
