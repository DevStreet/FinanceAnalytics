 ...
 */
public class DOGMASelect {
  private static DOGMASelect s_instance;
  DOGMASelect() {
  }
  public static DOGMASelect getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Select.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMASelect(boolean verbose) {
    s_verbose = verbose;
  };
  ...
  private static com.opengamma.maths.highlevelapi.functions.DOGMAFunctions.DOGMAIndexing.select.SelectOGMatrix s_selectogmatrix = new com.opengamma.maths.highlevelapi.functions.DOGMAFunctions.DOGMAIndexing.select.SelectOGMatrix();
static {
...
OperatorDictionaryPopulator<VoidUnaryFunction<OGArray<? extends Number>>> operatorDictVoidUnary = OperatorDictionaryPopulatorLibrary.getVoidUnaryOperatorDictionary();
  ...
  public static com.opengamma.maths.highlevelapi.datatypes.primitive.OGArray<? extends java.lang.Number> select(com.opengamma.maths.highlevelapi.datatypes.primitive.OGArray arg0, int[] arg1, com.opengamma.maths.highlevelapi.functions.DOGMAFunctions.DOGMAIndexing.assign.Index arg2){
    return   s_selectogmatrix.select( arg0,  arg1,  arg2);
  };
  public static com.opengamma.maths.highlevelapi.datatypes.primitive.OGArray<? extends java.lang.Number> select(com.opengamma.maths.highlevelapi.datatypes.primitive.OGArray arg0, com.opengamma.maths.highlevelapi.functions.DOGMAFunctions.DOGMAIndexing.assign.Index arg1, int[] arg2){
    return   s_selectogmatrix.select( arg0,  arg1,  arg2);
  };
  public static com.opengamma.maths.highlevelapi.datatypes.primitive.OGArray<? extends java.lang.Number> select(com.opengamma.maths.highlevelapi.datatypes.primitive.OGArray arg0, int[] arg1, int[] arg2){
    return   s_selectogmatrix.select( arg0,  arg1,  arg2);
  };
