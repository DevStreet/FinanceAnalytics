 ...
 */
public class DOGMAIsSquare {
  private static DOGMAIsSquare s_instance;
  DOGMAIsSquare() {
  }
  public static DOGMAIsSquare getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(IsSquare.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMAIsSquare(boolean verbose) {
    s_verbose = verbose;
  };
  ...
  private static UnaryFunctionChain[] s_issquareInstructions;
static {
...
UnaryFunction<OGArray<? extends Number>, OGArray<? extends Number>>[] IsSquareFunctionTable = MethodScraperForUnaryFunctions.availableMethodsForUnaryFunctions(operatorDictUnary.getOperationsMap(),IsSquare.class);
s_issquareInstructions = MethodScraperForUnaryFunctions.computeFunctions(ConversionCostAdjacencyMatrixStore.getWeightedAdjacencyMatrix(),IsSquareFunctionTable, defaultUnaryFunctionEvalCostsMatrix);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_issquareInstructions[type1], arg0);
return tmp;
}

public static Number issquare(Number arg0) {Catchers.catchNullFromArgList(arg0, 1);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_issquareInstructions[type1], arg0rewrite);
