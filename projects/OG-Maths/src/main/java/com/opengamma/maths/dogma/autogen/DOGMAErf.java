 ...
 */
public class DOGMAErf {
  private static DOGMAErf s_instance;
  DOGMAErf() {
  }
  public static DOGMAErf getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Erf.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMAErf(boolean verbose) {
    s_verbose = verbose;
  };
