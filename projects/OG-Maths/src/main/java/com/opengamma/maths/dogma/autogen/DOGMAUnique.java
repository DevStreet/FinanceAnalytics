 ...
 */
public class DOGMAUnique {
  private static DOGMAUnique s_instance;
  DOGMAUnique() {
  }
  public static DOGMAUnique getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Unique.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMAUnique(boolean verbose) {
    s_verbose = verbose;
  };
  ...
  private static UnaryFunctionChain[] s_uniqueInstructions;
static {
...
UnaryFunction<OGArray<? extends Number>, OGArray<? extends Number>>[] UniqueFunctionTable = MethodScraperForUnaryFunctions.availableMethodsForUnaryFunctions(operatorDictUnary.getOperationsMap(),Unique.class);
s_uniqueInstructions = MethodScraperForUnaryFunctions.computeFunctions(ConversionCostAdjacencyMatrixStore.getWeightedAdjacencyMatrix(),UniqueFunctionTable, defaultUnaryFunctionEvalCostsMatrix);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_uniqueInstructions[type1], arg0);
return tmp;
}

public static Number unique(Number arg0) {Catchers.catchNullFromArgList(arg0, 1);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_uniqueInstructions[type1], arg0rewrite);
