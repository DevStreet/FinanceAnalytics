 ...
 */
public class DOGMAPlus {
  private static DOGMAPlus s_instance;
  DOGMAPlus() {
  }
  public static DOGMAPlus getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Plus.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMAPlus(boolean verbose) {
    s_verbose = verbose;
  };
