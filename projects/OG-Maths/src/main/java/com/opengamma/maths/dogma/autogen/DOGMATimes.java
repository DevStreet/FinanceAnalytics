 ...
 */
public class DOGMATimes {
  private static DOGMATimes s_instance;
  DOGMATimes() {
  }
  public static DOGMATimes getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Times.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMATimes(boolean verbose) {
    s_verbose = verbose;
  };
