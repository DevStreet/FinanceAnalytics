 ...
 */
public class DOGMATranspose {
  private static DOGMATranspose s_instance;
  DOGMATranspose() {
  }
  public static DOGMATranspose getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Transpose.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMATranspose(boolean verbose) {
    s_verbose = verbose;
  };
