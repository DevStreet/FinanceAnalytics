 ...
 */
public class DOGMAPower {
  private static DOGMAPower s_instance;
  DOGMAPower() {
  }
  public static DOGMAPower getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Power.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMAPower(boolean verbose) {
    s_verbose = verbose;
  };
  ...
  private static InfixOpChain[][] s_powerInstructions;
static {
...
InfixOperator<OGArray<? extends Number>, OGArray<? extends Number>, OGArray<? extends Number>>[][] PowerFunctionTable = MethodScraperForInfixOperators.availableMethodsForInfixOp(operatorDictInfix.getOperationsMap(),Power.class, s_verbose);
s_powerInstructions = MethodScraperForInfixOperators.computeFunctions(ConversionCostAdjacencyMatrixStore.getWeightedAdjacencyMatrix(),PowerFunctionTable, defaultInfixFunctionEvalCostsMatrix);
  ...
  public static OGArray<? extends Number> power(OGArray<? extends Number> arg0, OGArray<? extends Number> arg1) {
    ...
    OGArray<? extends Number> tmp = s_infixOpChainRunner.dispatch(s_powerInstructions[type1][type2], arg0, arg1);
    return tmp;
  }
...
int type2 = MatrixTypeToIndexMap.getIndexFromClass(arg1.getClass());
  OGArray<? extends Number> tmp = s_infixOpChainRunner.dispatch(s_powerInstructions[type1][type2], arg0rewrite, arg1);
  return tmp;
}
...
arg1rewrite = new OGComplexScalar(arg1);
 ...
 int type2 = MatrixTypeToIndexMap.getIndexFromClass(arg1rewrite.getClass());
  OGArray<? extends Number> tmp = s_infixOpChainRunner.dispatch(s_powerInstructions[type1][type2], arg0, arg1rewrite);
  return tmp;
}
...
arg1rewrite = new OGComplexScalar(arg1);
 ...
 int type1 = MatrixTypeToIndexMap.getIndexFromClass(arg0rewrite.getClass());
 int type2 = MatrixTypeToIndexMap.getIndexFromClass(arg1rewrite.getClass());
  OGArray<? extends Number> tmp = s_infixOpChainRunner.dispatch(s_powerInstructions[type1][type2], arg0rewrite, arg1rewrite);
