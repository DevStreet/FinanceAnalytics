 ...
 */
public class DOGMACtranspose {
  private static DOGMACtranspose s_instance;
  DOGMACtranspose() {
  }
  public static DOGMACtranspose getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Ctranspose.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMACtranspose(boolean verbose) {
    s_verbose = verbose;
  };
