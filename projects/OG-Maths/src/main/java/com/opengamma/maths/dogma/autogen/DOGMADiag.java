 ...
 */
public class DOGMADiag {
  private static DOGMADiag s_instance;
  DOGMADiag() {
  }
  public static DOGMADiag getInstance() {
    return s_instance;
  }
  private static Logger s_log = LoggerFactory.getLogger(Diag.class);
  // switch for chatty start up
  private static boolean s_verbose;
  public DOGMADiag(boolean verbose) {
    s_verbose = verbose;
  };
  ...
  private static UnaryFunctionChain[] s_diagInstructions;
static {
...
UnaryFunction<OGArray<? extends Number>, OGArray<? extends Number>>[] DiagFunctionTable = MethodScraperForUnaryFunctions.availableMethodsForUnaryFunctions(operatorDictUnary.getOperationsMap(),Diag.class);
s_diagInstructions = MethodScraperForUnaryFunctions.computeFunctions(ConversionCostAdjacencyMatrixStore.getWeightedAdjacencyMatrix(),DiagFunctionTable, defaultUnaryFunctionEvalCostsMatrix);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_diagInstructions[type1], arg0);
return tmp;
}

public static Number diag(Number arg0) {Catchers.catchNullFromArgList(arg0, 1);
...
OGArray<? extends Number> tmp = s_unaryFunctionChainRunner.dispatch(s_diagInstructions[type1], arg0rewrite);
