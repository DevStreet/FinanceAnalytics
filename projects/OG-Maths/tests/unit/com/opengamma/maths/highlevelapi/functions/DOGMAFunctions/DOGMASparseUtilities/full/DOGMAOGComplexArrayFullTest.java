...
public class DOGMAOGComplexArrayFullTest {
  ...
  private static FullOGComplexArray f = FullOGComplexArray.getInstance();
  ...
  public static void fullTest() {
    ...
    OGComplexArray answer = new OGComplexArray(realdata, imagdata);
    OGComplexArray p = new OGComplexArray(realdata, imagdata);
