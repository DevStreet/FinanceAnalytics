 ...
 */
public class GeneratorLegIbor extends GeneratorInstrument<GeneratorAttributeIROTC> {
   ...
   */
  public GeneratorLegIbor(String name, IborIndex iborIndex, Calendar depositCalendar, Calendar fixingCalendar, Tenor paymentTenor, DayCount dayCount, 
      BusinessDayConvention businessDayConvention, Currency currency, boolean endOfMonth, int spotLag, Calendar paymentCalendar, StubType stubType, 
      boolean isExchangeNotional, int paymentLag) {
    super(name);
   ...
   */
  @Override
  public AnnuityDefinition<? extends CouponDefinition> generateInstrument(ZonedDateTime date, double marketQuote, double notional, GeneratorAttributeIROTC attribute) {
  ...
  public AnnuityDefinition<? extends CouponDefinition> generateInstrumentFromEffectiveDate(final ZonedDateTime effectiveDate, final double spread, final double notional, 
    ...
    if (_isExchangeNotional) {
      return AnnuityDefinitionBuilder.couponIborSpreadWithNotional(effectiveDate, maturityDate, _paymentTenor.getPeriod(), notional, spread, _iborIndex, isPayer, 
          _dayCount, _businessDayConvention, _endOfMonth, _paymentCalendar, _fixingCalendar, _depositCalendar, _stubType, _paymentLag, true, true);
    }
    return AnnuityDefinitionBuilder.couponIborSpread(effectiveDate, maturityDate, _paymentTenor.getPeriod(), notional, spread, _iborIndex, isPayer, _dayCount, 
        _businessDayConvention, _endOfMonth, _paymentCalendar, _fixingCalendar, _depositCalendar, _stubType, _paymentLag);
  }
  ...
  public AnnuityDefinition<? extends CouponDefinition> generateInstrument(ZonedDateTime date, double notional, GeneratorAttributeIROTC attribute, final boolean isPayer) {
    ...
    if (_isExchangeNotional) {
      return AnnuityDefinitionBuilder.couponIborWithNotional(startDate, maturityDate, _paymentTenor.getPeriod(), notional, _iborIndex, isPayer, _dayCount, 
          _businessDayConvention, _endOfMonth, _paymentCalendar, _fixingCalendar, _depositCalendar, _stubType, _paymentLag, true, true);
    }
    return AnnuityDefinitionBuilder.couponIbor(startDate, maturityDate, _paymentTenor.getPeriod(), notional, _iborIndex, isPayer, _dayCount, _businessDayConvention, 
        _endOfMonth, _paymentCalendar, _fixingCalendar, _depositCalendar, _stubType, _paymentLag);
  }
   ...
   * @return The leg.
   */
  public AnnuityDefinition<? extends CouponDefinition> generateInstrumentFromEffectiveDate(ZonedDateTime effectiveDate, double notional, final Tenor maturityTenor, final boolean isPayer) {
    ArgumentChecker.notNull(maturityTenor, "attribute");
    final ZonedDateTime maturityDate = TenorUtils.adjustDateByTenor(effectiveDate, maturityTenor);
    if (_isExchangeNotional) {
      return AnnuityDefinitionBuilder.couponIborWithNotional(effectiveDate, maturityDate, _paymentTenor.getPeriod(), notional, _iborIndex, isPayer, _dayCount, 
          _businessDayConvention, _endOfMonth, _paymentCalendar, _fixingCalendar, _depositCalendar, _stubType, _paymentLag, true, true);
    }
    return AnnuityDefinitionBuilder.couponIbor(effectiveDate, maturityDate, _paymentTenor.getPeriod(), notional, _iborIndex, isPayer, _dayCount, _businessDayConvention, 
        _endOfMonth, _paymentCalendar, _fixingCalendar, _depositCalendar, _stubType, _paymentLag);
  }
  ...
  public boolean equals(Object obj) {
    ...
    GeneratorLegIbor other = (GeneratorLegIbor) obj;
