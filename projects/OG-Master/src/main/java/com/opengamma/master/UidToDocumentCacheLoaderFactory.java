...
public class UidToDocumentCacheLoaderFactory extends CacheLoaderFactory {

  @Override
  public CacheLoader createCacheLoader(Ehcache ehcache, Properties properties) {
    return new UidToDocumentCacheLoader();
  }

  public class UidToDocumentCacheLoader implements CacheLoader {
