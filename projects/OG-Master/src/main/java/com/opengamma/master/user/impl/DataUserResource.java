...
public class DataUserResource extends AbstractDocumentDataResource<UserDocument> {
   ...
   * The users resource.
   */
  private final DataUserMasterResource _masterResource;
  /**
   ...
   *
   * @param masterResource the parent resource, not null
   * @param oid the user unique identifier, not null
   */
  public DataUserResource(final DataUserMasterResource masterResource, final ObjectId oid) {
    ArgumentChecker.notNull(masterResource, "masterResource");
    ArgumentChecker.notNull(oid, "user");
    _masterResource = masterResource;
    _urlResourceId = oid;
  }
   ...
   */
  public DataUserMasterResource getMasterResource() {
    return _masterResource;
  }
   ...
   */
  @Override
  protected UserMaster getMaster() {
    return getMasterResource().getMaster();
  }
