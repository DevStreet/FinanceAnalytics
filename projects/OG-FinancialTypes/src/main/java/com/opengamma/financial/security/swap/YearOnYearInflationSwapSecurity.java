...
public class YearOnYearInflationSwapSecurity extends SwapSecurity {
  ...
  public static class Meta extends SwapSecurity.Meta {
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 1793327747:  // exchangeNotional
          return ((YearOnYearInflationSwapSecurity) bean).isExchangeNotional();
        case 110246592:  // tenor
          return ((YearOnYearInflationSwapSecurity) bean).getTenor();
      }
    ...
    protected void propertySet(Bean bean, String propertyName, Object newValue, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 1793327747:  // exchangeNotional
          ((YearOnYearInflationSwapSecurity) bean).setExchangeNotional((Boolean) newValue);
          return;
        case 110246592:  // tenor
          ((YearOnYearInflationSwapSecurity) bean).setTenor((Tenor) newValue);
          return;
      }
    ...
    protected void validate(Bean bean) {
      JodaBeanUtils.notNull(((YearOnYearInflationSwapSecurity) bean)._tenor, "tenor");
      super.validate(bean);
    }
