...
public class ConventionBuildersTest extends AbstractFudgeBuilderTestCase {
  ...
  public void testCMSLegConvention() {
    final CMSLegConvention convention = new CMSLegConvention("EUR CMS", 
        ExternalIdBundle.of(InMemoryConventionBundleMaster.simpleNameSecurityId("EUR CMS")),
  ...
  public void testCompoundingIborLegConvention() {
    final CompoundingIborLegConvention convention = 
        new CompoundingIborLegConvention("EUR Compounded", 
            ExternalIdBundle.of(InMemoryConventionBundleMaster.simpleNameSecurityId("EUR Compounded")),
            ExternalId.of("Test", "EURIBOR 3M"), Tenor.SIX_MONTHS, CompoundingMethod.FLAT, Tenor.THREE_MONTHS, 
  ...
  public void testDepositConvention() {
    final DepositConvention convention = new DepositConvention("EUR Deposit", 
        ExternalIdBundle.of(InMemoryConventionBundleMaster.simpleNameSecurityId("EUR Deposit")),
  ...
  public void testFXForwardAndSwapConvention() {
    final FXForwardAndSwapConvention convention = new FXForwardAndSwapConvention("USD/CAD", 
        ExternalIdBundle.of(InMemoryConventionBundleMaster.simpleNameSecurityId("USD/CAD")),
  ...
  public void testFXSpotConvention() {
    final FXSpotConvention convention = new FXSpotConvention("USD/CAD", 
        ExternalIdBundle.of(InMemoryConventionBundleMaster.simpleNameSecurityId("USD/CAD")),
  ...
  public void testIborIndexConvention() {
    final IborIndexConvention convention = new IborIndexConvention("EUR Deposit", 
        ExternalIdBundle.of(InMemoryConventionBundleMaster.simpleNameSecurityId("EUR Deposit")),
        DayCounts.ACT_365, BusinessDayConventions.FOLLOWING, 2, true,
  ...
  public void testInterestRateFutureConvention() {
    final InterestRateFutureConvention convention = new InterestRateFutureConvention("ER", 
        ExternalIdBundle.of(InMemoryConventionBundleMaster.simpleNameSecurityId("ER")),
  ...
  public void testFederalFundsFutureConvention() {
    final FederalFundsFutureConvention convention = new FederalFundsFutureConvention("FF", 
        ExternalIdBundle.of(InMemoryConventionBundleMaster.simpleNameSecurityId("FF")),
  ...
  public void testDeliverablePriceQuotedSwapFutureConvention() {
    final DeliverablePriceQuotedSwapFutureConvention convention = new DeliverablePriceQuotedSwapFutureConvention("T1U", 
        ExternalIdBundle.of(InMemoryConventionBundleMaster.simpleNameSecurityId("T1U")),
  ...
  public void testIMMFRAConvention() {
    final RollDateFRAConvention convention = new RollDateFRAConvention("IMM FRA", 
        InMemoryConventionBundleMaster.simpleNameSecurityId("IMM FRA").toBundle(),
  ...
  public void testIMMSwapConvention() {
    final RollDateSwapConvention convention = new RollDateSwapConvention("IMM Swap", 
        InMemoryConventionBundleMaster.simpleNameSecurityId("IMM Swap").toBundle(),
  ...
  public void testOISLegConvention() {
    final OISLegConvention convention = new OISLegConvention("EUR OIS", 
        ExternalIdBundle.of(InMemoryConventionBundleMaster.simpleNameSecurityId("EUR OIS")), 
        ExternalId.of("Test", "EONIA"), Tenor.SIX_MONTHS, BusinessDayConventions.MODIFIED_FOLLOWING, 1, true, 
        StubType.LONG_START, false, 4);
    convention.setUniqueId(UniqueId.of("Test", "123"));
  ...
  public void testOvernightIndexConvention() {
    final OvernightIndexConvention convention = new OvernightIndexConvention("EONIA", 
        ExternalIdBundle.of(InMemoryConventionBundleMaster.simpleNameSecurityId("EONIA")),
  ...
  public void testPriceIndexConvention() {
    final PriceIndexConvention convention = new PriceIndexConvention("CPI", 
        ExternalIdBundle.of(InMemoryConventionBundleMaster.simpleNameSecurityId("CPI")), Currency.USD, 
        ExternalId.of("Region", "US"), ExternalId.of("Test", "CPI"));
  ...
  public void testSwapConvention() {
    final SwapConvention convention = new SwapConvention("EUR Swap", 
        ExternalIdBundle.of(InMemoryConventionBundleMaster.simpleNameSecurityId("EUR Swap")),
  ...
  public void testSwapFixedLegConvention() {
    final SwapFixedLegConvention convention = new SwapFixedLegConvention("EUR Fixed Leg", 
        ExternalIdBundle.of(InMemoryConventionBundleMaster.simpleNameSecurityId("EUR Fixed Leg")),
  ...
  public void testSwapIndexConvention() {
    final SwapIndexConvention convention = new SwapIndexConvention("EUR 3m Swap", 
        ExternalIdBundle.of(InMemoryConventionBundleMaster.simpleNameSecurityId("EUR 3m Swap")),
  ...
  public void testVanillaIborLegConvention() {
    final VanillaIborLegConvention convention = new VanillaIborLegConvention("EUR 3m Swap", 
        ExternalIdBundle.of(InMemoryConventionBundleMaster.simpleNameSecurityId("EUR 3m Swap")),
        ExternalId.of("Test", "3m Euribor"), true, Interpolator1DFactory.LINEAR, Tenor.THREE_MONTHS, 2, true, 
        StubType.SHORT_END, false, 7);
    convention.setUniqueId(UniqueId.of("Test", "12345"));
  ...
  public void testInflationLegConvention() {
    final InflationLegConvention convention = new InflationLegConvention("CPI", 
        ExternalIdBundle.of(InMemoryConventionBundleMaster.simpleNameSecurityId("CPI")),
