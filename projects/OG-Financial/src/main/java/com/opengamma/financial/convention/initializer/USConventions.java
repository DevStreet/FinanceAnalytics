...
public class USConventions extends ConventionMasterInitializer {
  ...
  public void init(final ConventionMaster master) {
    ...
    //
    // ON - Fed Funds
    final ExternalId overnightConventionId = ExternalId.of(OG_SYNTHETIC_TICKER, "FEDL01 Index");
    ...
    final DepositConvention depositONConvention = new DepositConvention(
        "USDDepoON", ExternalIdBundle.of("CONVENTION", "USDDepoON"), ACT_360, FOLLOWING, 0, false, Currency.USD, US);
    //
    //// IMM FRA
    ...
    final SwapFixedLegConvention fixedLeg1YPayLagConvention = new SwapFixedLegConvention(
        "USDFixed1Y_PayLag", ExternalIdBundle.of("CONVENTION", "USDFixed1Y_PayLag"),
    ...
    final OISLegConvention oisONLegConvention = new OISLegConvention(
        "USDFEDFUNDCmp1Y", ExternalIdBundle.of("CONVENTION", "USDFEDFUNDCmp1Y"), overnightConventionId,
    ...
    final SwapFixedLegConvention irsFixedLegConvention = new SwapFixedLegConvention(
        "USD 6M Govt Fixed Leg", ExternalIdBundle.of("CONVENTION", "USD 6M Govt Fixed Leg"),
    ...
    final VanillaIborLegConvention liborLeg3MConvention = new VanillaIborLegConvention(
        "USD 3M Govt Ibor Leg", ExternalIdBundle.of("CONVENTION", "USD 3M Govt Ibor Leg"),
        ExternalId.of(OG_SYNTHETIC_TICKER, "USDLIBORP3M"), true, Interpolator1DFactory.LINEAR, Tenor.THREE_MONTHS, 2, true, StubType.SHORT_START, false, 0);
    ...
    final VanillaIborLegConvention liborLeg6MConvention = new VanillaIborLegConvention(
        "USD 6M Govt Ibor Leg", ExternalIdBundle.of("CONVENTION", "USD 6M Govt Ibor Leg"),
        ExternalId.of(OG_SYNTHETIC_TICKER, "USDLIBORP6M"), true, Interpolator1DFactory.LINEAR, Tenor.SIX_MONTHS, 2, true, StubType.SHORT_START, false, 0);
    ...
    //final ExternalId legIbor3MIMMQConventionId = ExternalId.of(USDFEDFUNDCmp1Y, legIbor3MIMMQConventionName);
    ...
    // Ibor Index
    final IborIndexConvention usdliborIndexConvention = new IborIndexConvention("USD Libor",
    ...
    // Overnight Index
    final OvernightIndexConvention usdOvernightIndexConvention = new OvernightIndexConvention("USD Overnight",
                                                                                              ExternalIdBundle.of(
                                                                                                  ExternalId.of(
                                                                                                      "BLOOMBERG_CONVENTION_NAME",
                                                                                                      "Federal Funds Effective Rate U"),
                                                                                                  ExternalId.of(
                                                                                                      "BLOOMBERG_TICKER",
                                                                                                      "FEDL01 Index"),
                                                                                                  ExternalId.of(
    ...
    addConvention(master, usdliborIndexConvention);
    addConvention(master, usdOvernightIndexConvention);
  }
