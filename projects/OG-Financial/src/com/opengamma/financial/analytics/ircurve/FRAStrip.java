...
public class FRAStrip extends CurveStrip {
  ...
  public int compareTo(final CurveStrip other) {
    ...
    final FRAStrip otherFRA = (FRAStrip) other;
    result = getResetTenor().getPeriod().toPeriodFields().toEstimatedDuration().compareTo(otherFRA.getResetTenor().getPeriod().toPeriodFields().toEstimatedDuration());
    if (result != 0) {
      return result;
    }
  ...
  public String toString() {
    final StringBuffer sb = new StringBuffer("FRAStrip[tenor=");
