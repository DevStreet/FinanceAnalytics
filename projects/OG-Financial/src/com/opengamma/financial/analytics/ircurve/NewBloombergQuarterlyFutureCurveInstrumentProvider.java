 ...
 * 
 */
public class NewBloombergQuarterlyFutureCurveInstrumentProvider {
  ...
  public NewBloombergQuarterlyFutureCurveInstrumentProvider(final String futurePrefix, final String marketSector) {
  ...
  public ExternalId getInstrument(final LocalDate curveDate, final Tenor tenor, final int nFuturesFromTenor) {
    ...
    return createQuarterlyIRFutureStrips(curveDate, tenor, nFuturesFromTenor, _futurePrefix, _marketSector);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    final NewBloombergQuarterlyFutureCurveInstrumentProvider other = (NewBloombergQuarterlyFutureCurveInstrumentProvider) obj;
  ...
  public String toString() {
    return "BloombergQuarterlyFutureCurveInstrumentProvider[" + _futurePrefix + ", " + _marketSector + "]";
  }
}
