...
public abstract class RawSheetReader implements Closeable, Iterable<Map<String, String>> {
  ...
  public static RawSheetReader newSheetReader(ExternalFormat sheetFormat, InputStream inputStream) {
  ...
  public static RawSheetReader newSheetReader(String filename) {
    ...
    return newSheetReader(ExternalFormat.of(filename), inputStream);
  }
