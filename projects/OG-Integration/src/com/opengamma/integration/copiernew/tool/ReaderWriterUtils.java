...
public final class ReaderWriterUtils {
  ...
  public static Iterable getMasterReader(String type, String classifier, String baseUri, String searchFilter) {

    MasterClassInfo info = getMasterClassInfo(type);

    AbstractRemoteMaster master;
    try {
       Class<?> clazz = info.getRemoteMasterClass();
       master = (AbstractRemoteMaster) clazz.getConstructor(URI.class).newInstance(URI.create(baseUri + "/jax/components/"
  ...
  public static Iterable getMasterReader(String uri) {
    ...
    return getMasterReader(type, classifier, baseUri, searchFilter);
  }

  public static Writeable getMasterWriter(String type, String classifier, String baseUri, String renameTemplate) {
  ...
  public static SheetReader getSheetReader(String type, InputStream inputStream) {
    return null;
  }

  public static SheetWriter getSheetWriter(String type, OutputStream outputStream) {
    return null;
  }
}
