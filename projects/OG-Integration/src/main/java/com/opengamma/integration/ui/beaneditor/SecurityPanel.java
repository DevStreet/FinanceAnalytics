...
public class SecurityPanel extends JPanel {
  ...
  /** Logger. */
  private static final Logger s_logger = LoggerFactory.getLogger(SecurityPanel.class);
   ...
   */
  SecurityPanel(final SecurityMaster master) {
    // search panel
      ...
      public void actionPerformed(ActionEvent ev) {
        ...
        SwingWorker<List<UniqueNamedItem>, Void> sw = new SwingWorker<List<UniqueNamedItem>, Void>() {
          ...
          protected List<UniqueNamedItem> doInBackground() throws Exception {
            ...
            SecuritySearchResult result = master.search(request);
