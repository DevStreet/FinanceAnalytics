...
/**
 * Example code to load a swap desk portfolio.
 * <p>
 ...
 */
@Scriptable
public class ExampleSwapDeskPortfolioLoader extends AbstractTool<ToolContext> {

  /** Logger. */
  private static final Logger s_logger = LoggerFactory.getLogger(ExampleSwapDeskPortfolioLoader.class);
  ...
  public static void main(String[] args) { // CSIGNORE
    new ExampleSwapDeskPortfolioLoader().invokeAndTerminate(args);
  }
  ...
  protected void doRun() {
    ...
    final FederalFundsFutureSecurity futureSecurity = new FederalFundsFutureSecurity(
        new Expiry(ZonedDateTime.parse("2014-03-31T00:00Z"), ExpiryAccuracy.DAY_MONTH_YEAR),
        "XCBT",
        "XCBT",
        Currency.USD,
        416700.0,
        ExternalId.of("BLOOMBERG_TICKER", "FEDL01 Index"),
        "Interest Rate"
        );

    //final ManageablePosition position = createPositionAndTrade(futureSecurity);
  ...
  private Collection<EquitySecurity> loadEquitySecurities() {
    ...
    InputStream inputStream = ExampleSwapDeskPortfolioLoader.class.getResourceAsStream("example-equity.csv");
    try {
      if (inputStream != null) {
